...
def nuscenes_data_prep(root_path,
    ...
    #info_train_path = '/mnt/workspace/luyan/Datasets/3d_det/nuscenes/nuscenes_infos_train.pkl'
    #info_val_path = '/mnt/workspace/luyan/Datasets/3d_det/nuscenes/nuscenes_infos_val.pkl'

    nuscenes_converter.export_2d_annotation(
        root_path, info_trainval_path, version=version)
    nuscenes_converter.export_2d_annotation(
