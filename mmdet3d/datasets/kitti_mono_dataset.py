...
class KittiMonoDataset(NuScenesMonoDataset):
    ...
    def evaluate(self,
        ...
        if isinstance(result_files, dict):
            ap_dict = dict()
            #self.fusion_2d_3d_results(result_files)
    ...
    def fusion_2d_3d_results(self,results):
        new_result_files = []
        for sample_2d,sample_3d in \
                zip(results['img_bbox2d'],results['img_bbox']):
            sample_3d['bbox'] = sample_2d['bbox']
