...
class Bottleneck(BaseModule):
    ...
    def __init__(self, 
        ...
        self.conv1 = build_conv_layer(
            ...
            1,
            bias=False)
        self.norm1 = dla_build_norm_layer(norm_cfg, bottle_planes)[1]
        self.conv2 = build_conv_layer(
            conv_cfg,
            bottle_planes,
            bottle_planes,
            ...
            dilation=dilation,
            bias=False)
        self.norm2 = dla_build_norm_layer(norm_cfg, bottle_planes)[1]
        self.conv3 = build_conv_layer(
            ...
            1,
            bias=False)
        nn.Conv2d(bottle_planes, out_channels,
                               kernel_size=1, bias=False)
        self.norm3 = dla_build_norm_layer(norm_cfg, out_channels)[1]
        self.relu = nn.ReLU(inplace=True)
        self.stride = stride
...
class BottleneckX(nn.Module):
    ...
    def __init__(self, in_channels, planes, stride=1, dilation=1):
        ...
        self.conv1 = nn.Conv2d(in_channels, bottle_planes,
                               kernel_size=1, bias=False)
        self.norm1 = BatchNorm(bottle_planes)
        self.conv2 = nn.Conv2d(bottle_planes, bottle_planes, kernel_size=3,
                               stride=stride, padding=dilation, bias=False,
                               dilation=dilation, groups=cardinality)
        self.norm2 = BatchNorm(bottle_planes)
        self.conv3 = nn.Conv2d(bottle_planes, planes,
                               kernel_size=1, bias=False)
        self.norm3 = BatchNorm(planes)
        self.relu = nn.ReLU(inplace=True)
        self.stride = stride
